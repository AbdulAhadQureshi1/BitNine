...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const user_con_pass = confirm_pass.current.value;
    if(user_email.length === 0) return;
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8 ">
            ...
            >
              ...
              >
              {loading ? 'Registering your account...' : 'Create an account'}
              </button>
          ...
          <p className="text-xl text-red-600">{error}<span className="text-green-600">{success}</span></p>
      </div>
    </section>
  );
};
